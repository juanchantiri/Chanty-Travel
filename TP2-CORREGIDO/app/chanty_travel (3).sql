...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2024 a las 22:05:33
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `reservas_ibfk_1` FOREIGN KEY (`id_reservas`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
